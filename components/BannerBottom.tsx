...
const BannerBottom = () => {
  return (
    <div className="max-w-7xl mx-auto flex flex-col gap-10 lg:gap-0 lg:flex-row justify-center items-center h-auto lg:h-60 bg-primaryColor/80 text-white py-10 px-8 -mt-20 z-50 border-[1px] border-secondaryColor border-b-0">
